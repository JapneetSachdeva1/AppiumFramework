...
public class FormPageTests extends BaseTest
{
    ...
    @BeforeMethod (description = "To reload the activity for login test")
    ...
    @Test(dataProvider = "getDataPositiveLogin", description = "Testing positive login scenario", priority = 1)
    ...
    @Test(dataProvider = "getDataNegativeLogin", description = "Testing negative login scenario", priority = 2)
